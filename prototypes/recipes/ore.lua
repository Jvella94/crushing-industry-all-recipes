...
if mods["space-age"] then
    if mods["enriching-industry"] then
        duplicate_recipe_and_replace_ingredient("molten-iron", "__space-age__/graphics/icons/fluid/molten-iron.png", "iron-ore", 50, "ei-enriched-iron-ore", 100, "__enriching-industry__/graphics/icons/enriched-iron-ore.png")
        duplicate_recipe_and_replace_ingredient("molten-copper", "__space-age__/graphics/icons/fluid/molten-copper.png", "copper-ore", 50, "ei-enriched-copper-ore", 100, "__enriching-industry__/graphics/icons/enriched-copper-ore.png")
        duplicate_recipe_and_replace_ingredient("tungsten-plate", "__space-age__/graphics/icons/tungsten-plate.png", "tungsten-ore", 4, "ei-enriched-tungsten-ore", 8, "__enriching-industry__/graphics/icons/enriched-tungsten-ore.png")
    else
