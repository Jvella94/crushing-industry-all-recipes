...
duplicate_recipe_and_replace_ingredient("advanced-circuit", "__base__/graphics/icons/advanced-circuit.png", "copper-cable", 4, "optical-fiber", "__crushing-industry__/graphics/icons/optical-fiber.png")
duplicate_recipe_and_replace_ingredient("beacon", "__base__/graphics/icons/beacon.png", "copper-cable", 10, "optical-fiber", "__crushing-industry__/graphics/icons/optical-fiber.png")
...
duplicate_recipe_and_replace_ingredient("selector-combinator", "__base__/graphics/icons/selector-combinator.png", "iron-gear-wheel", 5, "optical-fiber", "__crushing-industry__/graphics/icons/optical-fiber.png")
